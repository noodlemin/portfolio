...
import { g as getTimeDiff, a as getMonthName } from "../../../chunks/app.js";
  ...
  return `${validate_component(Card, "Card").$$render(
    ...
    {},
    {
      default: () => {
        ...
        })}</div></div> <div class="text-[var(--text)] text-[0.9em] font-200">${escape(period)}</div> <div class="experience-description">${escape(experience.shortDescription)}</div> <div class="flex flex-row flex-wrap mt-5">${each(experience.skills, (skill) => {
